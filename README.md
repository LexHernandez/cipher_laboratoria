...
Imagina que quieres hacer una fiesta, pero deseas evitar a esos colados que aunque no estan invitados llegan sin aviso, es por eso que necesitas comunicarte con mensajes que puedan leer las personas a quienes realmente quieres en tu fiesta. El cifrado Cesar es una herramienta utilizada desde el apogeo de la civilización Romana, y este es un cifrado sencillo que podemos utilizar para codificar mensajes.
